...
export function StudentHeader({ onMenuClick }: StudentHeaderProps) {
  ...
  const unreadNotifications = studentDashboardData.notifications.filter(
    (n) => !n.read
  ).length;
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuSeparator />
              {studentDashboardData.notifications.slice(0, 3).map((notif) => (
              ...
              <DropdownMenuItem asChild>
                <Link href="/student/notifications" className="text-center text-sm text-blue-600">
