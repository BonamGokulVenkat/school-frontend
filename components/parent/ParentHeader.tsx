...
const notifications: Notification[] = [
  {
    ...
    message: "Rahul was absent on October 15, 2026",
    time: "2 hours ago",
    read: false,
    type: "warning",
  },
      ...
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Welcome back, Mr. Rajesh Sharma</p>
          </div>
        </div>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 px-2">
                ...
                <div className="hidden text-left md:block">
                  <p className="text-sm font-medium text-slate-900">Mr. Rajesh</p>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuLabel>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium text-slate-900">Rajesh Sharma</p>
                  <p className="text-xs text-slate-500">rajesh@email.com</p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem>
